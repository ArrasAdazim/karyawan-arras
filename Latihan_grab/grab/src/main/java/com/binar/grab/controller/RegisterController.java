...
public class RegisterController {
    ...
    public ResponseEntity<Map> saveRegisterManual(@RequestBody RegisterRequest objModel) throws RuntimeException {
        Map map = new HashMap();
    ...
    public Map sendEmailRegister(@RequestBody RegisterRequest user) {
