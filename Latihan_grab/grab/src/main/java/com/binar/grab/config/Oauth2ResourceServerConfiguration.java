...
//    private static final String SECURED_PATTERN = "/api/**";
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatcher("/**")
                .authorizeRequests()
                .antMatchers("/v1/view/karyawan/**","/","/showFile/**","/v1/showFile/**","/v1/upload", "/user-register/**","/forget-password/**", "/oauth/authorize**", "/login**", "/error**","/v3/api-docs/**","/swagger-ui.html","/swagger-ui/**","/swagger-ui/index.html")
                .permitAll()
//                .antMatchers("/v1/view/karyawan/").hasAnyAuthority("ROLE_USER")
